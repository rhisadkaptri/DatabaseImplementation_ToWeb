<?php
    ...
    ?>
        <script>
            var yakin = confirm('Kamu bukan user. Login dengan akun user?');
...
<body>
     ...
     <!-- TEMPAT WISATA -->
     <section class="premium-section spad" id="tempat_wisata" data-stellar-background-ratio="0.5">
          <div class="container text-center">
               <div class="row">

                    <div class="col-md-12 col-sm-12">
                         <div class="section-title wow fadeInUp" data-wow-delay="0.1s">
                              <h2 style="padding-bottom:40px">TEMPAT WISATA</h2>
                              <div class="row">
