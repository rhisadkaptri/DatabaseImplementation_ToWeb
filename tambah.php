          ...
          <div class="container">
               ...
               <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                         ...
                         <li><a href="#profile" class="smoothScroll">About Me</a></li>
     ...
     <section id="portfolio" class="portfolio section-bg mb-5" style="margin-top: 50px">
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="container" style="height:500px;width:500px">
            ...
            <a href="tambah_tempat.php">Back</a>
            <p>Add Data</p>
            </h3>
            <form action="tambah_proses.php" method="post">
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" name="nama" size="30" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" name="lokasi" size="255" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="date" class="form-control" name="tanggal_jadi" size="30" required>
                    </div>
                </div>

                <div class="form-group row">
                    <div class="col-sm-11">&nbsp;</div>
                    <div class="col-sm-1"><input type="submit" name="tambah" value="Add"></div>
                </div>
            </form>
        </div>
      </div>
